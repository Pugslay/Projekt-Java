...
public class Karty {
    ...
    static int[] id = new int[31];
    static int[] atak = new int[31];
    static int[] hp = new int[31];
    static int[] pancerz = new int[31];
    static int[] koszt = new int[31];
    static String[] efekt = new String[31];
    static String[] efekt_2 = new String[31];
    static String[] nazwa = new String[31];
    ...
    public static void pobierz() throws SQLException { // tutaj
        int n = 1;

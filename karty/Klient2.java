...
public class Klient2 {
    ...
    private static MouseAdapter panelg1MouseListener, panelg2MouseListener, panelg3MouseListener, panelg4MouseListener, panelg5MouseListener, koniecMouseListener, winMouseListener;
    static JButton koniec,win;
            ...
            Thread serverThread = new Thread(() -> {
                try {
                    ...
                    while ((serverMessage = serverInput.readLine()) != null) {
                        ...
                        System.out.println("[Klient_2]:Wiadomość od serwera: " + serverMessage);
    ...
    private static void inicjalizacja(String nazwa) throws IOException, FontFormatException {
        Font customFont1 = Font.createFont(Font.TRUETYPE_FONT, new File("D:\\Studia\\Java\\testowanko\\Karty\\src\\main\\java\\com\\example\\karty\\alagard.ttf"));
        ...
        customFont1 = customFont1.deriveFont(100f);
        customFont2 = customFont2.deriveFont(50f);
        customFont3 = customFont3.deriveFont(20f);
...
//---------------------------------------------------------------------------------------------------------
    ...
    private static void processMessage(String message) {
        ...
        switch (kod) {
            case "win" -> {
                ...
                event_delete();
                winMouseListener = new MouseAdapter() {
                    @Override
                ...
                win.addMouseListener(winMouseListener);
                frame.add(win);
            }
            case "panele1" -> {
            ...
            case "usun" ->{
                ...
                String HP_J = parts[3];
                System.out.println("Klient2: "+ parts[2] + parts[3]);
                switch (pozycja){
                    case "panele1" -> {
                        panele1.removeAll();
                        if(ID!=0)
                            CP.InsertGraph(panele1, Integer.toString(insertKart.szukajATA(ID)), HP_J, Integer.toString(insertKart.szukajPAN(ID)), Integer.toString(insertKart.szukajKOSZT(ID)), InsertKart.szukajNazwa(ID), insertKart.szukajEfekty(ID));
                        panele1.repaint();
                    }
                    case "panele2" -> {
                        panele2.removeAll();
                        if(ID!=0)
                            CP.InsertGraph(panele2, Integer.toString(insertKart.szukajATA(ID)), HP_J, Integer.toString(insertKart.szukajPAN(ID)), Integer.toString(insertKart.szukajKOSZT(ID)), InsertKart.szukajNazwa(ID), insertKart.szukajEfekty(ID));
                        panele2.repaint();
                    }
                    case "panele3" -> {
                        panele3.removeAll();
                        if(ID!=0)
                            CP.InsertGraph(panele3, Integer.toString(insertKart.szukajATA(ID)), HP_J, Integer.toString(insertKart.szukajPAN(ID)), Integer.toString(insertKart.szukajKOSZT(ID)), InsertKart.szukajNazwa(ID), insertKart.szukajEfekty(ID));
                        panele3.repaint();
                    }
                    case "panele4" -> {
                        panele4.removeAll();
                        if(ID!=0)
                            CP.InsertGraph(panele4, Integer.toString(insertKart.szukajATA(ID)), HP_J, Integer.toString(insertKart.szukajPAN(ID)), Integer.toString(insertKart.szukajKOSZT(ID)), InsertKart.szukajNazwa(ID), insertKart.szukajEfekty(ID));
                        panele4.repaint();
                    }
                    ...
                    case "panel1" -> {
                        ...
                        panel1.setBorder(BorderFactory.createLineBorder(Color.RED, 3, true));
                        if(ID!=0)
                            CP.InsertGraph(panel1, Integer.toString(insertKart.szukajATA(ID)), HP_J, Integer.toString(insertKart.szukajPAN(ID)), Integer.toString(insertKart.szukajKOSZT(ID)), InsertKart.szukajNazwa(ID), insertKart.szukajEfekty(ID));
                        panel1.repaint();
                    }
                    case "panel2" -> {
                        panel2.removeAll();
                        panel2.setBorder(BorderFactory.createLineBorder(Color.RED, 3, true));
                        if(ID!=0)
                            CP.InsertGraph(panel2, Integer.toString(insertKart.szukajATA(ID)), HP_J, Integer.toString(insertKart.szukajPAN(ID)), Integer.toString(insertKart.szukajKOSZT(ID)), InsertKart.szukajNazwa(ID), insertKart.szukajEfekty(ID));
                        panel2.repaint();
                    }
                    case "panel3" -> {
                        panel3.removeAll();
                        panel3.setBorder(BorderFactory.createLineBorder(Color.RED, 3, true));
                        if(ID!=0)
                            CP.InsertGraph(panel3, Integer.toString(insertKart.szukajATA(ID)), HP_J, Integer.toString(insertKart.szukajPAN(ID)), Integer.toString(insertKart.szukajKOSZT(ID)), InsertKart.szukajNazwa(ID), insertKart.szukajEfekty(ID));
                        panel3.repaint();
                    }
                    case "panel4" -> {
                        panel4.removeAll();
                        panel4.setBorder(BorderFactory.createLineBorder(Color.RED, 3, true));
                        if(ID!=0)
                            CP.InsertGraph(panel4, Integer.toString(insertKart.szukajATA(ID)), HP_J, Integer.toString(insertKart.szukajPAN(ID)), Integer.toString(insertKart.szukajKOSZT(ID)), InsertKart.szukajNazwa(ID), insertKart.szukajEfekty(ID));
                        panel4.repaint();
                    }
                }
    ...
    private static void sprawdz_HP(){
        if(HP_E<=0) {
            win.setText("przegrales");
            event_delete();
            output.println("0;win");
            winMouseListener = new MouseAdapter() {
                @Override
                public void mouseClicked(MouseEvent e) {
                output.println("disconnect");
    ...
    private static void set_staty() {
        E_Zdrowie.setText(HP + "/20");
        Zdrowie.setText(HP_E + "/20");
